...
class Dataset:
    ...
    def map_subject_to_images(self, subjects_path_rgx='/net/mraid20/export/genie/LabData/Data/10K/aws_lab_files/ultrasound/jpg//00_00_visit/', path_to_save='us_dataset_by_id_and_date.npy'):
        dataset = {}
